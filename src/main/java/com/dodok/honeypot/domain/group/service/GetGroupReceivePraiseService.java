...
public class GetGroupReceivePraiseService {
    ...
    public GetGroupReceivePraiseResDto execute(Long memberId, Long groupId, Pageable pageable) {
        ...
        Slice<ReceivePraiseInfo> receivePraiseInfos = receivePraiseHelper.getGroupReceivePraiseInfos(groupId, pageable);
        return receivePraiseMapper.toGetGroupReceivePraiseResDto(receivePraiseInfos.getContent(), SliceInfo.of(receivePraiseInfos));
    }
}
