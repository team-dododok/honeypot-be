...
public class ReceivedStampByGroupQueryRepositoryImpl implements ReceivedStampByGroupQueryRepository {
     ...
     */
    @Override
    public List<StampDto> findAllReceivedStampByGroup(Long groupId) {
        return queryFactory
                ...
                .where(receivePraise.group.id.eq(groupId))
                .fetch();
    }
}
